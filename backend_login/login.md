...
実際の開発ではWebフレームワークを利用するため、今回学んだ内容を開発中に意識する場面は少ないかもしれません。それでも、Webアプリケーションの「裏側の仕組み」を理解しておくことは、より良い実装やトラブルシューティングのために、重要だと考えています！

次回以降は、

- DBについて深掘り
- チーム開発の基本！Git/GitHub, Dockerって？
- いろいろなWebフレームワークに触れる
- ソフトウェア工学、アーキテクチャを学ぶ

などを予定しています。今後も一緒に学んでくださったら嬉しいです！
