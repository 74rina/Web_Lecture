...
4. **CLI に慣れる**
   ...
   4-4. WSL 環境構築手順（Windowsの方向け）

   4-5. 基本的なLinuxコマンド

   4-6. Web開発でよく使うコマンドのインストール

5. **開発環境（コードエディタ）の構築**

   5-1. Visual Studio Code とは

   5-2. インストール・環境構築

   5-3. VSCode ショートカットキーまとめ
...
次章から、いきなり実践的な内容になっています。ぜひ最後までお読みください！
...
左上の`ファイル` > `新しいファイル` から、Pythonファイル（`test.py`）を作る。
...
| ファイル名検索              | `Ctrl + P`                      | `Cmd + P`          |
| 新規ファイル作成            | `Ctrl + N`                      | `Cmd + N`          |
| ファイル保存                | `Ctrl + S`                      | `Cmd + S`          |
| 全て保存                    | `Ctrl + K S`                    | `Cmd + Option + S` |
| タブを閉じる                | `Ctrl + W`                      | `Cmd + W`          |
...
- WIKINEWS "File:Internet Explorer 6.png"
  ...
  https://en.wikinews.org/wiki/File%3AInternet_Explorer_6.png
