...
3. **CLI に慣れる**
   ...
   3-2. コマンドはどこで打つ？
   3-3. bash系が世界標準
   3-4. WSL 環境構築手順（Windowsの方向け）
   3-5. 基本的なLinuxコマンド
   3-6. Web開発でよく使うコマンドのインストール
4. **開発環境（コードエディタ）の構築**
...
- より良い実装、迅速なデバッグ
- AIに的確な指示を出せる（使われる側ではなく使う側に）
- 上流工程（システムの設計、方向性の決定）で現実的な判断ができるようになる
- 趣味として楽しい

という点で、学ぶ意義があると思います。（・ω・　）ﾌｧ
...
※ WSLの `password` には、2-4で設定したWSLユーザのパスワードを入力。Macはログイン時に使用しているパスワード。
